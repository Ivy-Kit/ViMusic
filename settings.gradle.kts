...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        create("libs") {
            ...
            library("compose-shimmer", "com.valentinilk.shimmer", "compose-shimmer").version("1.0.5")

            library("compose-activity", "androidx.activity", "activity-compose").version("1.8.2")

            library("compose-coil", "io.coil-kt", "coil-compose").version("2.5.0")

            version("room", "2.6.1")
            library("room", "androidx.room", "room-ktx").versionRef("room")
            library("room-compiler", "androidx.room", "room-compiler").versionRef("room")

            version("media3", "1.3.0")
